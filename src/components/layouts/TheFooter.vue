    ...
    <div class="row footer-top">
      <div class="col-sm-5 col-lg-5">
        ...
        <div class="text-md">
          ...
          <a :id="`contacts-${index}`" v-for="(item, index) in contacts" :key="item.link" :href="item.link" :style="contactStyle" target="_blank">
            <b-tooltip :target="`contacts-${index}`" triggers="hover" :title="item.title"></b-tooltip>
        ...
        <div class="row">
          <div class="col-sm-4">
            ...
            <ul class="list-unstyled">
              <li v-for="(item, index) in sponsor.list" :key="item.link">
                <b-tooltip :target="`sponsor-${index}`" triggers="hover" :title="item.title"></b-tooltip>
                <a :id="`sponsor-${index}`" :href="item.link" target="_blank">
          ...
          <div class="col-sm-4">
            ...
            <ul class="list-unstyled">
              <li v-for="(item, index) in other.list" :key="item.link">
                <b-tooltip :target="`other-${index}`" triggers="hover" :title="item.title"></b-tooltip>
                <a :id="`other-${index}`" :href="item.link" target="_blank">
